                      ...
                      <g id="g-app-brand" stroke="none" stroke-width="1" fill="none" fill-rule="evenodd">
                        <g id="Brand-Logo" transform="translate(-27.000000, -15.000000)">
                          <g id="Icon" transform="translate(27.000000, 15.000000)">
                            ...
                            <span class="app-brand-text demo text-body fw-bolder">TuBu</span>
                        </a>
                    </div>
                    <!-- /Logo -->

                    <form id="formAuthentication" class="mb-3" action="{{request()->fullUrl()}}" method="POST">
                        @csrf
                        <div class="row">
                        ...
                        @if(isset($data['error']))
                            @php
                            if (isset($data['error']['firstname'])) {
                                $error = $data['error']['firstname'][0];
                            } else if(isset($data['error']['lastname'])) {
                                $error = $data['error']['lastname'][0];
                            } else if(isset($data['error']['username'])) {
                                 $error = $data['error']['username'][0];
                            } else if(isset($data['error']['email'])) {
                                 $error = $data['error']['email'][0];
                            } else if (isset($data['error']['telephone'])) {
                                 $error = $data['error']['telephone'][0];
                            } else if (isset($data['error']['password'])) {
